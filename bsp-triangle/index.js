...
function split(leftChild, rightChild, x, y, width, height) {
  ...
  if (isSplitHeight) {
    leftChild = new Leaf(x, y, width, niceSize);
    rightChild = new Leaf(x, y + niceSize, width, height - niceSize);
  } else {
    leftChild = new Leaf(x, y, niceSize, height);
    rightChild = new Leaf(x + niceSize, y, width - niceSize, height);
  }
